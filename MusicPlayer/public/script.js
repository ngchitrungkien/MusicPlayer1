...
const app={
    ...
    songs: [
        ...
        },
        {
            ...
            path: 'Assets/Đường Tôi Chở Em Về.mp3',
            image: 'Assets/duongtoichoemve.jpg'
        },
        {
            name: '2002' ,
            singer: 'Anne Marie',
        ...
        },
        {
            ...
            path: 'Assets/Sao Em Lại Tắt Máy.mp3',
            image: 'Assets/saoemlaitatmay.jpg'
        },
        {
            name: 'Theo Anh' ,
        ...
        },       
        {
            name: 'Girl On Fire' ,
            singer: 'Alicia Keys',
            path: 'Assets/Girl On Fire.mp3',
            image: 'Assets/girl.jpg'
        },
        {
            name: 'Nothing On You' ,
            singer: 'B.o.B x Bruno Mars',
            path: 'Assets/Nothing On You.mp3',
            image: 'Assets/nothingonyou.jpg'
        },
        {
            name: 'Chuyện Rằng' ,
            singer: 'Thịnh Suy',
            path: 'Assets/Chuyện Rằng.mp3',
            image: 'Assets/chuyenrang.jpg'
        },
        {
            name: 'To The Moon' ,
            singer: 'Hooligan',
